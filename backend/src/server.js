...
// so express-rate-limit refuses to use it and throws
// ERR_ERL_UNEXPECTED_X_FORWARDED_FOR on every single request, which is
// what was causing the 500 errors on login.
...
const ALLOWED_ORIGINS = [
  ...
  'https://villa-vogue-bms-dpth.vercel.app',
  /^https:\/\/villa-vogue-bms.*\.vercel\.app$/,
  'https://villavoguefashion.com',
  'https://www.villavoguefashion.com',
];
